/**
 * Iconos SVG reutilizables para los componentes
 * Usar como componentes: <IconName className="w-6 h-6" />
 */

import React from 'react';

// Icono de reparación - llave inglesa
...
// Icono de instalación - clipboard
