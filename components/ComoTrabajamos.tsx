...
const pasos = [
  {
    ...
    descripcion: 'Nos escribís por WhatsApp contar-nos qué le pasa a tu caldera. Te respondemos rápido y te preguntamos algunos detalles.',
    icono: (
  ...
  },
  {
    ...
    descripcion: 'Según el problema, acordamos un turno para que nuestro técnico pase a tu domicilio. Si es urgente, intentamos venir el mismo día.',
    icono: (
  ...
  {
    numero: '03',
    titulo: 'Diagnóstico en tu casa',
    descripcion: 'El técnico llega a tu domicilio, revisa la caldera y te explica qué tiene. Si requiere repuestos, te dice qué necesita y el costo.',
    icono: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    numero: '04',
    titulo: 'Resolución',
    descripcion: 'Con tu aprobación, reparamos la caldera. El precio que acordamos es el que pagás — sin surprises. Probamos que funcione antes de irnos.',
    icono: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
